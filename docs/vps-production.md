...
контейнер приложения ограничен 8 GB: фактическое потребление MinerU на учебнике в несколько
сотен страниц превысило 6.6 GB вместе с двумя API workers. Таймаут передаётся непосредственно
в MinerU subprocess; при его превышении дочерний процесс завершается, а ingest возвращает
ошибку вместо зависшего worker.
