...
class Settings(BaseSettings):
    ...
    query_expansions_by_subject: dict[str, dict[str, list[str]]] = {
        ...
        "russian_language": {
            ...
            "сравнение": ["сравнительный оборот", "придаточное сравнения", "степень сравнения"],
            "синтаксическими синонимами": ["придаточные", "члены предложения", "соответствуют"],
            "план синтаксического разбора": ["порядок разбора", "схема", "грамматические основы"],
            "выбор знака препинания": ["смысловые отношения", "интонация", "бессоюзное предложение"],
        },
        "safety": {
        ...
        "geography": {
            "автомобильный транспорт": ["автотранспорт", "загрязнение", "выбросы", "окружающая среда"],
            "материалоемкие": ["материалоемкость", "сырье", "источники сырья"],
            "металлургические предприятия поволжья": ["металлургия", "поволжье", "центры"],
        },
        "chemistry": {
            "сульфид меди": ["черный осадок", "хлорид меди", "сульфид натрия"],
        },
    }
