    ...
    def _rows_to_hits(rows, *, return_text: bool, debug: bool) -> list[dict]:
        ...
        for r in rows:
            payload = {
                ...
                "answer_focus": r.answer_focus,
                "answer_alignment_score": float(r.answer_alignment_score),
                "required_entities": list(r.required_entities),
                "required_entity_score": float(r.required_entity_score),
                ...
                "answer_alignment_boost_value": float(r.answer_alignment_boost_value),
                "entity_penalty_value": float(r.entity_penalty_value),
